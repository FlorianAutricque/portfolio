    ...
    <>
      ...
      <div className={styles.containerExp}>
        ...
        <Scroll position={styles.left}>
          ...
          React.js, Tailwind CSS, supabase, Redux.js, JavaScript eXtension
          (JSX), CSS Modules, Styled Components, Context API, React Router
        </Scroll>
        ...
        <Scroll position={styles.left}>
          ...
          <span>
            <BiSolidLocationPlus /> Gunnedah solar plant and Woolooga solar
            plant (Australia)
          </span>
        ...
        <Scroll position={styles.right}>
          ...
          individuals involved in underground electric cable work, with a focus
          on optimizing team organization. <br />- Ensuring quality assurance
          and quality control of combiner boxes and power conditioning units
          (PCUs).performance.
        </Scroll>
        ...
        <Scroll position={styles.left}>
          ...
          <br /> <br />- Managing a team of 15 individuals. Organizing their
          tasks and increasing their performances.
          ...
          <br /> - Conducting quality assurance and quality control assessments
          of modules deployed in the field, verifying their adherence to
          specified standards.
        </Scroll>
        ...
        <Scroll position={styles.right}>
          ...
          <br /> <br />- Leading hand of the workshop area. Managing a team of
          30 people. <br />- Conducting thorough quality checks and implementing
        ...
        <Scroll position={styles.left}>
          ...
          - Preparing customer orders with attention to detail and accuracy.{" "}
          <br />- Commitment to safety by strictly adhering to established
        ...
        <Scroll position={styles.left}>
          ...
          <br />
          - Problem solving <br />- Collaborating with colleagues to ensure
          smooth store operations. <br />- Customer interactions, store
          security, and safety protocols. <br />
          - Arranging products in an organized and visually appealing manner.
          <br /> - Inventories, conducting stock checks, and notifying
          management when products need to be restocked.
        </Scroll>
      </div>
    </>
  );
